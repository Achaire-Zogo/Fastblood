...
class BloodPocketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('gestionnaire.bloodpockets.index', compact('bloodpockets'));
    }
    ...
    public function create()
    {
        ...
        ->where('enabled', 1)->get();
        return view('gestionnaire.bloodpockets.create', compact('bloodbanks'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('gestionnaire.bloodpockets.edit', compact('bloodpocket', 'bloodbanks'));
        } catch(\Exception $e) {
            return back();
        }
    }
