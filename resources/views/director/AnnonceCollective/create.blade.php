                        ...
                        <div class="card-body">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('directeur.annonce_collective.index') }}">directeur</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Creer une Annonce Collective</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
