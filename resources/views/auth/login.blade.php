...
<section style="background-image: url(img/bg-img/blood.jpg); background-repeat: no-repeat; background-attachment: fixed; background-size: cover; height: 100vh;">
	<div class="col-lg-4 bg-white" style="height: 100vh; box-shadow: 0 5px 40px rgba(0, 0, 0, 0.15);">
		...
		<div class="mx-auto">
			<form style="margin-left: 40px;" action="/login" method="POST">
            @csrf
        {{csrf_field()}}
				<label class="text-dark" style="text-align: right !important;">Email</label><br/>
				<input type="email" name="email" placeholder="vous@example.com" style="height: 45px; width: 80%;" class="border border-muted mb-3" id="mail">
                @error('email')
		...
		<div class="text-center mt-3">
			<p>Vous n'avez pas encore de compte? <span><a href="{{ route('signuppage') }}">inscrivez-vous</a></span></p>
		</div>
